The file "latin_snowball.py" is a stemming text for Latin modeled closely to the "snowball.py" stemmer for English. See data directory for helpful manipulations of the Perseus morphological data.
